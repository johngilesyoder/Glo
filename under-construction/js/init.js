  $(document).ready(function (){
    ...
    $('#newsletter').ajaxChimp({
      language: 'lj',
      url: 'http://energetechs.us5.list-manage.com/subscribe/post?u=2f4557632b4be4552415ad41a&amp;id=b3253e9144'
    });
    ...
    $.ajaxChimp.translations.lj = {
      'submit': 'Submitting...',
      0: '<i class="fa fa-check"></i> We will be in touch very soon!',
