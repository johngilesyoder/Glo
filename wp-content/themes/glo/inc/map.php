    ...
    <div class="row">
      <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2">
        <div class="america-outline">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/usa-outline2.svg">
        </div>
        <div class="headquarters">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="address-wrapper last-one">
                <address>
                  <strong><a target="_blank" href="https://406windows.com">406 Window Co.</a></strong>
                  +1 (406) 656-9091<br>
                  3039 Grand Ave. Ste B<br>
